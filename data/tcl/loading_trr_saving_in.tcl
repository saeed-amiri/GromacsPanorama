...
set mol [mol new @GRO type gro waitfor all]
puts "Attempting to load file: $mol"
set distance 5

mol addfile @TRR type trr first @FIRST last @LAST step STEP waitfor all molid $mol
...
for {set i 0} {$i < $nf} {incr i} {
    ...
    if {[llength $resIDs] > 0} {
        ...
        set completeInRadiusResidues [atomselect top "@FINALSELECT $uniqueResIDs"]
        $completeInRadiusResidues @WRITE "@OUTNAME_${i}.@EXTENSION"
